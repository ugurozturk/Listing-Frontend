...
export default class SystemCreatedGameLists extends AbpBase {
  ...
  get list() {
    return this.$store.state.systemCreatedList.list[1] ? this.$store.state.systemCreatedList.list[1].systemCreatedListItemCollection.items : this.$store.state.systemCreatedList.list;
  };
  get loading() {
