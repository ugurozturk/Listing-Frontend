...
import {EditUserCreatedList} from "../../store/entities/user-created-list";
@Component
export default class EditUserList extends AbpBase {
    @Prop({ type: Boolean, default: false }) value: boolean;
    userCreatedList: EditUserCreatedList = new EditUserCreatedList();
    get listTypes(){
